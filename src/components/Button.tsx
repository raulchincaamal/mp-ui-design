...
const colorVariants: Record<Type, IColorVariants> = {
  default: {
    bgColor: 'bg-blue-800 border-blue-800 hover:bg-blue-900 hover:border-blue-900 shadow ',
    color: 'text-white',
  },
  primary: {
    bgColor:
...
export const Button = ({ children, type = 'default', onClick, isDisabled }: IButton) => {
